...
app=Flask(__name__)
app.config["SECRET_KEY"]='f781864e49b0aa317c716230'
...
with app.app_context():
	db.create_all()
# insert admin data one time only when you first run the web server. After this comment out these 3 lines of code.
